...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 8705749397917377848),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 6669571758927425927),
        name: 'bleName',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 7315806844566857338),
        name: 'data',
        type: 9,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    id: const obx_int.IdUid(2, 8610503172569272388),
    name: 'Note',
    lastPropertyId: const obx_int.IdUid(4, 6592545481709874323),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 577037567293592796),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 2868407158777661484),
        name: 'text',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 6852497984512255916),
        name: 'comment',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 6592545481709874323),
        name: 'date',
        type: 10,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(2, 8610503172569272388),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    BleLog: obx_int.EntityDefinition<BleLog>(
      model: _entities[0],
      toOneRelations: (BleLog object) => [],
      toManyRelations: (BleLog object) => {},
      getId: (BleLog object) => object.id,
      setId: (BleLog object, int id) {
        object.id = id;
      },
      objectToFB: (BleLog object, fb.Builder fbb) {
        final bleNameOffset = object.bleName == null
            ? null
...
/// [BleLog] entity fields to define ObjectBox queries.
class BleLog_ {
  /// See [BleLog.id].
  static final id = obx.QueryIntegerProperty<BleLog>(
    _entities[0].properties[0],
  );

  /// See [BleLog.bleName].
  static final bleName = obx.QueryStringProperty<BleLog>(
    _entities[0].properties[1],
  );

  /// See [BleLog.data].
  static final data = obx.QueryStringProperty<BleLog>(
...
class Note_ {
  ...
  /// See [Note.comment].
  static final comment = obx.QueryStringProperty<Note>(
